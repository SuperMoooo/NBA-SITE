...
function TeamCard({ id, name }) {
    ...
    return (
        <li className="p-8 bg-white border border-gray-200 rounded-lg shadow gap-2 flex flex-col items-center justify-center transition duration-300 hover:scale-105">
            ...
            />
            <p className="lg:text-2xl md:text-xl sm:text-lg font-normal">
                {name}
            </p>
            <div className="h-full flex justify-end items-end">
                <Link
                    ...
                    className="p-4 pt-3 pb-3 uppercase text-center bg-gray-100 border border-gray-400  rounded-lg shadow   font-extralight sm:text-2xl text-lg"
                >
                    ABOUT
                </Link>
            </div>
